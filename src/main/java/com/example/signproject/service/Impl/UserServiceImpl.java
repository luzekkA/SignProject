...
import com.example.signproject.Utils.FileUploadUtil;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public ResultJson<Object> getUserByToken(String token) {
        try {
            ...
            if (user != null) {
                ...
                infoViewModel.setIco(user.getIco());
            ...
            if (register.getId() != null) {
                ...
                if (user == null) {
                    ...
                    if (register.getPassword().equals(register.getConfirmpassword()) &&
                        ...
                        user.setRoles(Roles.valueOf(register.getRole()));
    ...
    public ResultJson<Object> getRoleList() {
        return ResultJson.success(Roles.values());
    }
    ...
    public ResultJson<Object> uploadIco(MultipartFile file, Serializable id) {
        ...
        if (file != null) {
            ...
            ResultJson<Object> resultJson = FileUploadUtil.uploadFile(file);
